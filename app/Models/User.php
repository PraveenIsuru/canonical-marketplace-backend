...
class User extends Authenticatable implements MustVerifyEmail, PasskeyUser
{
     ...
     *
     * The column has a database default too, but a freshly created model would not
     * know about it, so `is_admin` would serialise as null on the registration
     * response rather than false. The client reads this field to derive the
     * administrator role, and null is not the same answer as false.
     *
